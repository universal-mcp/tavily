...
This repository contains an implementation of an Tavily Universal MCP (Model Context Protocol) server. It provides a standardized interface for interacting with Tavily's tools and services through a unified API.
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_tavily/server.py
   ```
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_tavily/server.py
   ```
